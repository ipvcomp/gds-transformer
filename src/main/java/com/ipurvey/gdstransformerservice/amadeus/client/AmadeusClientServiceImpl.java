...
import com.ipurvey.gdstransformerservice.clients.HttpRestClient;
...
public class AmadeusClientServiceImpl implements AmadeusClientService {
    ...
    @Autowired
    public AmadeusClientServiceImpl( HttpRestClient client, AmadeusConfigurations amadeusConfigurations) {
        this.client = client;
